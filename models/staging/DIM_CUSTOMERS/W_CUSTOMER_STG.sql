...
(  
    SELECT
        ...
        __ROW_MD5 AS __ROW_MD5,
        __DLH_IS_DELETED AS __DLH_IS_DELETED,
        __DLH_SYNC_TS AS __DLH_SYNC_TS,
        __DLH_START_TS AS __DLH_START_TS,
        __DLH_FINISH_TS AS __DLH_FINISH_TS,
        __DLH_IS_ACTIVE AS __DLH_IS_ACTIVE
    FROM
    source
)
